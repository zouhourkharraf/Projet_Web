      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="index.html" method="post" onsubmit="return verif_formulaire(event)" name="form1">
            ...
            <div class="form-group">
              <p id="erreur2"></p>
              <input type="password" class="form-control"  placeholder="Le nouveau mot de passe (minimum: 6 chiffres et maximum: 20 chiffres)" name="new_password1">
            </div>

            <div class="form-group">
              <p id="erreur3"></p>
              <input type="password" class="form-control"  placeholder="Confirmation du nouveau mot de passe" name="new_password2">
            </div>
