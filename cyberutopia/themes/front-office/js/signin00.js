...
function verif_formulaire(e){
    ...
    else if( !(est_un_nombre(mp1) ) || (mp1.length<6)|| (mp1.length>20)  )
    ...
    //permet de générer automatiquement le pseudo à partir du nom et du prénom si on clique sur le champ du pseudo ou lors de la vérification de la formulaire
