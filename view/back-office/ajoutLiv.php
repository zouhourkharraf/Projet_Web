...
$livreur=new livreur($login,$nom,$prenom,$tel,$secteur,$date_naiss,$mail,$mdp,$num_permis,$dispo,$note);
...
<label for="nom">nom</label>
    ...
    title="lettres seulement" name="nom" placeholder="nom" id="nom">
      <label for="prenom">prenom</label>
    <input type="text" class="form-control" name="prenom" pattern="[A-Za-z]+" 
    title="lettres seulement" placeholder="prenom" id="prenom">
 ...
 <label for="tel"> numéro téléphone </label>
   ...
   <label for="date_naiss">date de naissance </label>
    ...
    <button type="submit" class="btn btn-info" onclick="return veriflivreur()">ajouter livreur</button>
    <a href="livreur.php " class="btn btn-info"> Retour </a>
  </form>
