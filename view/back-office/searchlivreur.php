...
$listelivreurs=$livreurc->chercherlivreur($search_value);
?>
?>
...
<head>
    ...
    <title>gestion des livreur</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <form method="get" action="searchlivreur.php">
    ...
    <form method="get" action="triliv.php">
    ...
    <td><a href="carte.php?lieu=<?=  $livreur->secteur; ?>"><i class="mdi mdi-map-marker-multiple"></i><?= $livreur->secteur; ?></a></td>
      <td> <?= $livreur->tel; ?> </td>
...
<a onclick="return confirm('voulez vous supprimer cette entrée ?')" href="supprimerlivreur.php?login=<?= $livreur->login ?>" class="btn btn-danger"> supprimer </a>
