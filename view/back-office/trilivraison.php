...
$listlivraisons=$livraisonc->trier();
?>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                              <a href="ajoutLiv.php "   class="btn btn-info"> ajouter un livraison   </a>

                                                       <form method="get" action="imprim.php">
           <input type="submit" class="float-right"  value="imprimer">
       </form>

                              <form method="get" action="chart.php">
           <input type="submit" class="float-right"  value="statistique">
       </form>
    ...
    <form method="get" action="trilivraison.php">
     ...
     <td><a href="carte.php?lieu=<?=  $livraison->lieuLivraison; ?>"><i class="mdi mdi-map-marker-multiple"></i><?=  $livraison->lieuLivraison; ?></a></td>
                                                     ...
                                                     <td>                                                
                                                         ...
                                                         <a href="modifierlivraison.php?idcommande=<?= $livraison->idcommande ?> " class="btn btn-info"> modifier </a> 
                                                <a onclick="return confirm('voulez vous supprimer cette entrée ?')" href="supprimerlivraison.php?id=<?= $livraison->idcommande ?>" class="btn btn-danger"> supprimer </a>
