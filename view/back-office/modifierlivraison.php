            ...
            <!-- Nav Item - Tables -->
              <li class="nav-item active">
                <a class="nav-link" href="livraison.php">
                    ...
                    <li class="nav-item active">
                <a class="nav-link" href="livreur.php">
                    <i class="fas fa-fw fa-table"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">gestion des livraisons</h1>
...
<br>
      ...
      <th scope="col">dateCommande   <br></th>
<th><input type="date" name="datecommande" value="<?php echo $row['datecommande'] ?>"></th>
...
<br>
      ...
      <th scope="col">etatCommande   <br></th>
...
<br>
      ...
      <th scope="col">lieuLivraison   <br></th>
...
<br>
      ...
      <th scope="col">prixLivraison   <br></th>
...
<br>
      ...
      <th scope="col">montantCommande   <br></th>
...
<input type="hidden" name="idcommande_ini" value="<?PHP echo $_GET['idcommande'];?>"  </th>
 <a href="livraison.php " class="btn btn-danger"> Retour </a>
    </tr>
...
$livraison=new livraison($datecommande,$montantCommande,$etatCommande,$lieuLivraison,$prixLivraison,$idLivreur,$idClient,$etatCommande);

    $livraisonc->modif($livraison,$_POST['idcommande_ini']);
