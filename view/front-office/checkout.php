...
<?php
require_once "C:/xampp/htdocs/projetlivraison/model/livraison.php";
require_once "C:/xampp/htdocs/projetlivraison/controller/livraisonC.php";

$livraisonC=new livraisonC();

     if ( isset($_POST['ajoutliv']))
{
...
$livraison=new livraison($dateCommande,$montantCommande,$etatCommande,$lieuLivraison,$prixLivraison,$idLivreur,$idClient,$etat);
...
<div class="page-wrapper">
   <div class="checkout shopping">
      <div class="container">
       ...
       <label for="montantCommande">montantCommande</label>
    <input type="text" class="form-control" name="montantCommande" placeholder="montantCommande" id="montantCommande" required="true">
 <label for="lieuLivraison">lieuLivraison</label>
    <select name="lieuLivraison" id="lieuLivraison" class="form-control">
...
<br>
     <button type="submit" class="btn btn-info" name="ajoutliv">ajouter livraison</button>
     
    <a href="note.php?idLivreur=<?= $idLivreur ?>"   class="btn btn-info"> noter livreur </a>
                 </form>
                        </div>
                     </div>
                  </div>
